...
export default {
  ...
  mounted() {
    ...
    leftSeries.dataFields.valueX = "capital_accuracy";
    leftSeries.dataFields.subValueX = "capital_correct_ans";
    leftSeries.dataFields.subTwoValueX = "capital_wrong_ans";
    ...
    rightSeries.dataFields.valueX = "capital_accuracy";
    // rightSeries.dataFields.valueXShow = "percent";
    // rightSeries.calculatePercent = true;
    rightSeries.dataFields.subValueX = "capital_correct_ans";
    rightSeries.dataFields.subTwoValueX = "capital_wrong_ans";
